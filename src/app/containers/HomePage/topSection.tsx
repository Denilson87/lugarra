...
export function TopSection() {
  ...
  return <TopSectionContainer>
    <LeftContainer>
      ...
      <Description>
        Sempre escolha o melhor carro em nossas lojas locais ou faça o pedido remotamente
        ao melhor preço para você e obtenha os carros da melhor qualidade que você gosta.
      </Description>
